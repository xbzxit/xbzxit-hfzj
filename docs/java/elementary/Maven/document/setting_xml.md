...
<localRepository>E:/DeveloperPack/maven/apache-maven-3.5.2/repository</localRepository>
...
<repositories>
        <repository>
          ...
          <name>dddd</name>
          <url>http://192.168.43.45:9091/nexus/content/repositories/releases</url>
        </repository>
        <repository>
          <id>nexus_central</id>
          <name>dddd</name>
          <url>http://192.168.43.45:9091/nexus/content/repositories/central</url>
        </repository>
        <repository>
          <id>nexus_snapshots</id>
          <name>dddd</name>
          <url>http://192.168.43.45:9091/nexus/content/repositories/snapshots</url>
        </repository>
</repositories>
```
   ...
   <mirror>
    ...
    <mirror>
     ...
     <mirror>
      ...
      <mirrorOf>*</mirrorOf>
      <name>Human Readable Name for this Mirror.</name>
      <url>http://192.168.43.45:9091/nexus/content/groups/public/</url>
    </mirror>
  </mirrors>
```
